...
export default class Bars extends PIXI.Graphics {
    ...
    draw() {
        ...
        bars.drawRect(5, 195 - barHeight, 15, barHeight)
        bars.endFill()
        ...
        bars.drawRect(5, 195 - (bars.resources.cpu.requested + bars.resources.cpu.reserved) * cpuHeight, 2.5, (bars.resources.cpu.requested + bars.resources.cpu.reserved) * cpuHeight)
        bars.beginFill(getBarColor(bars.resources.cpu.used, bars.resources.cpu.capacity), 1)
        bars.drawRect(7.5, 195 - bars.resources.cpu.used * cpuHeight, 2.5, bars.resources.cpu.used * cpuHeight)
        bars.endFill()
        bars.lineStyle(1, App.current.theme.primaryColor, 1)
        bars.drawRect(5, 195 - bars.resources.cpu.reserved * cpuHeight, 5, bars.resources.cpu.reserved * cpuHeight)
        ...
        bars.drawRect(14, 195 - (bars.resources.memory.requested + bars.resources.memory.reserved) / scale, 2.5, (bars.resources.memory.requested + bars.resources.memory.reserved) / scale)
        bars.beginFill(getBarColor(bars.resources.memory.used, bars.resources.memory.capacity), 1)
        bars.drawRect(16.5, 195 - bars.resources.memory.used / scale, 2.5, bars.resources.memory.used / scale)
        bars.endFill()
        bars.lineStyle(1, App.current.theme.primaryColor, 1)
        bars.drawRect(14, 195 - bars.resources.memory.reserved / scale, 5, bars.resources.memory.reserved / scale)

        bars.lineStyle(1, App.current.theme.primaryColor, 1)
        for (var i = 0; i < bars.resources.cpu.capacity; i++) {
            bars.drawRect(5, 195 - (i + 1) * cpuHeight, 5, cpuHeight)
        }

        bars.drawRect(14, 195 - bars.resources.memory.capacity / scale, 5, bars.resources.memory.capacity / scale)
